...
def play_game():
    ...
    players = {
        "MANUEL NEUER": ["GERMANY", ["BAYERN MUNICH", "SCHALKE 04"]],
        "CHRISTIAN ERIKSEN": ["DENMARK", ["AJAX", "MANCHESTER UNITED", "TOTTENHAM"]],
        "SIMON KJÆR": ["DENMARK", ["MILAN"]],
        "ZLATAN IBRAHIMOVIC": ["SWEDEN", ["MILAN", "BARCELONA", "PSG"]],
    }
    #set active player
    ...
    while True:
        ...
        if active_player == player1:
            ...
            player1_club = random.choice(clubs_player1) #brug playerhasplayedinclub til at vise Ajax, men ikke spilleren.
            ...
            while True:
                if player2_club in player2_used_clubs:
                    if len(player2_used_clubs) == len(clubs_player2):
                        ...
                        return
                    player2_club = random.choice(clubs_player2) #brug playerhasplayedinclub til at vise Ajax, men ikke spilleren.
                else:
                    break    
